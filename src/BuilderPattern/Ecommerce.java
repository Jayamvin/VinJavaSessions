...
public class Ecommerce {
	...
	// Builder pattern says that from each and every method can return the current class object. current class is always represented by this keyword 
	// whenever you write the this keyword in return always use the class name instead of void-- it is returning current class 
