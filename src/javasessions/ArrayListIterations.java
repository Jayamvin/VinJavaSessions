...
public class ArrayListIterations {
	...
	public static void main(String[] args) {
		...
		//see this after ArrayListConcept 
		...
		System.out.println(numList.get(0) + numList.get(2));//get(0)--zero is the index here 
...
//		System.out.println(marksList);
    ...
    //	   System.out.println(colorsList[x]); --- wrong way of accessing for ArrayList 
    	  
       }
       System.out.println("This is for dynamic ArrayList");
  ...
  // *********************************************    
       ...
       String color[] = new String[4];
          ...
          for(int z = 0; z<color.length -1; z++) {
        	  System.out.println(color[z]);
          }
        System.out.println("This is for Array literals ");
